    ...
    public class HttpEventCollectorEventInfo
    {
        ...
        public struct LoggerEvent
        {
           ...
           public string MessageTemplate { get; private set; }
            ...
            internal LoggerEvent(string id, string level, string MessageTemplate, string renderedMessage, object properties) : this()
            {
                this.Id = id;
                this.Level = level;
        ...
        public HttpEventCollectorEventInfo(string id, string level, string messageTemplate, string renderedMessage, object properties, Metadata metadata) 
            : this(DateTime.UtcNow, id, level, messageTemplate, renderedMessage, properties, metadata)
        {}
        ...
        public HttpEventCollectorEventInfo(
            DateTime datetime, string id, string level, string messageTemplate, string renderedMessage, object properties, Metadata metadata)
        {
            ...
            Event = new LoggerEvent(id, level, messageTemplate, renderedMessage, properties);
        }
    }
}
